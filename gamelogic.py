...
def explore_location():
    # Simuliere die Wahl eines zufälligen Ereignisses
    random_event = random.choice(random_encounter)
    print(f"Du befindest dich an einem neuen Ort. {random_event}")

    if "Kampf" in random_event:
        random_encounter()
